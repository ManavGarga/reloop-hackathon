    ...
    <>
      <header style={{ position: 'sticky', top: 0, zIndex: 100, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flex: 1, height: '40px', borderRadius: '4px', overflow: 'hidden', background: 'white' }}>
            <div style={{
              background: '#f3f3f3',
              color: '#555555',
              padding: '0 12px',
            ...
            <input 
              type="text" 
              placeholder="Search Amazon ReLoop for sustainable products, NGOs, or orders..." 
              style={{
                flex: 1,
                border: 'none',
                padding: '0 12px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            <NavLink to="/profile" style={{ textDecoration: 'none', color: 'white', display: 'flex', flexDirection: 'column', fontSize: '12px' }}>
              <span style={{ color: '#cccccc' }}>Hello, Priya</span>
              <span style={{ fontWeight: '700' }}>Account & Profile</span>
            </NavLink>
